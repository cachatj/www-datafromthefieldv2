;(function () {
  var n
  ;((n = jQuery).countdown = function (t, e) {
    var r,
      o = this
    return (
      (this.el = t),
      ...
      (r = function (t) {
        ...
        return (
          (r =
            (Date.parse(
              n.isPlainObject(o.options.date)
                ? o.options.date
                : new Date(o.options.date)
            ) -
              Date.parse(new Date())) /
            1e3) <= 0 &&
          ...
          r >= 86400 &&
            ((e.days = Math.floor(r / 86400)), (r -= 86400 * e.days)),
          r >= 3600 &&
            ((e.hours = Math.floor(r / 3600)), (r -= 3600 * e.hours)),
      ...
      (this.start = function (t) {
        return (
          null == t &&
            (t = o.options.refresh || n.countdown.defaultOptions.refresh),
    ...
    (n.fn.countdown = function (t) {
      return n.each(this, function (e, r) {
        var o
        if (!(o = n(r)).data('countdown'))
          return o.data('countdown', new n.countdown(r, t))
      })
    })
}.call(this))
