/*
*	Rabbit - Coming Soon & Under Construction Hugo Theme
*	Version: 1.0.1
*	Author: Mountain-Themes
*	Author URL: https://themeforest.net/user/mountain-themes
*	Rabbit © 2024. Design & Coded by Mountain-Themes.
*/
...
/* ================================= */
	...
	setTimeout(function() {
		$(".coming-soon .header-section .social-icons").delay(1000).css({display: 'none'}).fadeIn(1000);
		$(".coming-soon .header-section .actions").delay(1000).css({display: 'none'}).fadeIn(1000);
		$(".coming-soon .header-section hr").delay(1000).css({display: 'none'}).fadeIn(1000);
		$(".coming-soon .header-section p").delay(1000).css({display: 'none'}).fadeIn(1000);
